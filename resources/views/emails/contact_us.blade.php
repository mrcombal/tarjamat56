...
<head>
    ...
    <![endif]-->
    <title>Email from Tarjamat Contact Us</title>
                ...
                <table class="sm-w-full" style="font-family: 'Montserrat',Arial,sans-serif; width: 600px;"  role="presentation">
                    <tr>
                        <td class="sm-py-32 sm-px-24" style="font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; padding: 48px; text-align: center;" align="center">
                            <a href="#">
                                <img src="https://arabictarjamat.com/images/tarjamat-logo.svg"
                                     width="155" alt="Tarjamat" style="border: 0; max-width: 100%; line-height: 100%; vertical-align: middle;">
                            </a>
                        </td>
                    </tr><tr>
                        <td align="center" class="sm-px-24" style="font-family: 'Montserrat', Arial, sans-serif;">
                            <table style="font-family: 'Montserrat', Arial, sans-serif; width: 100%;" role="presentation">
                                <tr>
                                    <td class="sm-px-24" style="--bg-opacity: 1; background-color: #ffffff; background-color: rgba(255, 255, 255, var(--bg-opacity)); border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 14px; line-height: 24px; padding: 48px; text-align: left; --text-opacity: 1; color: #626262; color: rgba(98, 98, 98, var(--text-opacity));" bgcolor="rgba(255, 255, 255, var(--bg-opacity))" align="left">
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    {{ $data['assist_type'] == 1 ? 'Get a Quote' : ($data['assist_type'] == 2 ? 'Join the Team' : 'General Inquiry') }}
                                                </td>
                                            </tr>
                                            <tr>
...
<script>
    import Tab from "../../../../frontend/src/views/components/tab/Tab";
    export default {
        components: {Tab}
    }
</script>
